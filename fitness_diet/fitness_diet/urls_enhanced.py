...
from . import views_enhanced as views_rule_based
...
urlpatterns = [
    ...
    path('maintain-weight-plan/', views.maintain_weight_plan, name='maintain_weight_plan'),
    path('dashboard/', views.dashboard, name='dashboard'),
    path('predict-weight-change/', views.predict_weight_change, name='predict_weight_change'),
    ...
    # Rule-based system URLs
    path('diet_plan/', views_rule_based.diet_plan_view, name='diet_plan'),
    path('workout_plan/', views_rule_based.workout_plan_view, name='workout_plan'),
    path('saved-results/', views.saved_results, name='saved_results'),
